package com.cucumber.testng.application_utils.ui;
...
import static com.cucumber.testng.utilities.misc_utils.StringUtililties.getRand;
...
public class UIObjects {
    ...
    public static boolean javaScriptExecutorPageReady(JavascriptExecutor js) {
        js.executeScript("((JavascriptExecutor) driver)\n" +
    ...
    public static WebElement getElement(By locatorKey) {
        ...
        try {
            ...
            assertFail("Failure in Element Extraction using " + locatorKey + " - " + ex.getMessage());
            return null;
        }
    }
    ...
    public static WebElement handleUnkownException(By locatorKey, WebDriverException se) {
        ...
        if (error.contains("Cannot find context with specified id")) {
            ...
            assertFail("Failure in Element Extraction using " + locatorKey + " - " + se.getMessage());
            return null;
        }
    }
